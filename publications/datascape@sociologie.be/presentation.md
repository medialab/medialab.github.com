...
[<br>RICardo<br>Trade between Nations from c. 1800 to 1938](http://jiminy.medialab.sciences-po.fr/eat_datascape)<!-- .element: style="background-color: #DDDDDD;"-->
===
...
![chain of references (Latour 1993)](./assets/reference_chain.png)<!-- .element: style="width:80%;margin:0; padding-left:10%"--><br><center style="margin-top:-15px">(Latour 1993)</center>

===
###Chain of symbolisms
![Chain of symbolisms (MacCloud 1993)](./assets/From-Understanding-Comics-by-Scott-McCloud.jpg)<!-- .element: style="margin:0"--> 
...
# Datascape<!-- .element: style="font-size:4em"-->
![Bullshit!](./assets/bullshit.png)<!-- .element: style="margin-top:-120px;margin-left:250px" class="fragment" data-fragment-index="1"-->
##Just the way we do E.D.A.<!-- .element: class="fragment" data-fragment-index="2"-->

===

## Facing data deluge?<!-- .element: style="text-align:center"-->
<center>
...
<br>
<br>
*Thank you for your attention.*<!-- .element: class="fragment" data-fragment-index="1"-->
<br>
<br>
<small>
Paul Girard  
...
===
![un commit sur la base vue sur github](./assets/github_ricardo.png)<!-- .element: style="margin:0;padding:0"-->
...
archives > images > spreadsheet > git(csv) > database > data visualizations **> csv**<!-- .element: class="fragment" data-fragment-index="1"-->
