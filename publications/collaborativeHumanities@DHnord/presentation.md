...
---
<center>
![Simon Vanesse, Paul Girard, Initiation à la Recherche: Etude expérimentale visant à évaluer la qualité d’une coopération dans la conduite d’un processus multivariable. Sujet proposé par M Gilles Le Cardinal. Université de Technologie de Compiègne. Printemps 2002](./img/IR_2002.png)<!-- .element: style="width:80%"--></center>
---
...
---
## Com'une douche
![](./img/clientChaud.jpg)<!-- .element: style="width:48%;margin:0px;display:inline;" --> ![](./img/clientFroid.jpg)<!-- .element: style="width:48%;margin:0px;display:inline;" -->
---

![](./img/results_group1.png)<!-- .element: style="width:60%;margin:0px;display:inline;" -->
---
...
![](./img/results_group2.png)<!-- .element: style="width:60%;margin:0px;display:inline;" -->
---
...
---
[![logo médialab](img/SciencesPO_MEDIALAB.png)<!-- .element: style="height: 150px;"-->](http://medialab.sciencespo.fr)
